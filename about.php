...
<body>
    ...
    <main>
        ...
        <section class="legal-section fade-in" id="terms">
            <div class="container">
                <div class="about-legal-header">
                    <span class="about-legal-label">Legal Framework</span>
                    <h2 class="about-legal-title">Terms of Service & Privacy Policy</h2>
                    <div class="about-legal-divider"></div>
                </div>

                <div class="legal-content">
                    <div class="legal-block">
                        <h3>1. Medical Disclaimer</h3>
                        <p>The information provided by SynerQi is for informational purposes only and is not intended as a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of our certified physicians regarding any medical condition.</p>
                    </div>

                    <div class="legal-block">
                        <h3>2. Data Privacy & HIPAA</h3>
                        <p>We are committed to protecting your privacy. All patient data collected via our booking system—including contact details and health history—is handled in accordance with local health privacy regulations. We utilize industry-standard encryption to ensure your data remains secure and confidential.</p>
                    </div>

                    <div class="legal-block">
                        <h3>3. Appointment & Cancellation</h3>
                        <p>By booking an appointment, you agree to provide accurate information. We kindly request a 24-hour notice for any cancellations or rescheduling to allow us to serve other patients effectively.</p>
                    </div>
                ...
                <div class="legal-footer-note">
                    <p>Last updated: April 2026. For further legal inquiries, please contact us at our Ortigas Center office.</p>
                </div>
            </div>
        </section>
